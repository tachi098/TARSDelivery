    ...
    public class AccountSeeders
    {
        public AccountSeeders(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>().HasData(
                ...
                new Account { Id = 2, FullName = "Pham Xuan Hoai", Email = "hoaixp@gmail.com", Password = "$2a$11$VkOpTPdd8aQPsDMQYA2qb.zfGKHV7AWELUCiLGW9VULaEVF3ItsFW", Address = "Binh Thanh", Phone = "0933691822", Birthday = DateTime.Parse("3/21/1998 12:00:00 AM"), Avartar = "images/p1.png", Create_at = DateTime.Now },
